...
if (isset($_POST['Address1'], $_POST['City'], $_POST['State'], $_POST['total'])) {
    ...
    $query = "INSERT INTO orders (customerID, orderDate, address, totalPrice)
        VALUES ('$user','$date','$address', '$total')";
