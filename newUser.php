...
<html lang="en">
    ...
    <body>
        ...
        <div id="newUser">
            <form name="newUser_form" action="login.php">
                <fieldset id="newUser_section">
                    ...
                    <input type="password" id="passwrd" placeholder="At least 6 characters"
                            pattern=".{6,}" title="6 or more characters" required><br>
                    <label for="confirmPasswrd">Confirm Password:</label>
                    <input type="password" id="confirmPasswrd" placeholder="Re-enter password" 
                            pattern=".{6,}" title="6 or more characters" required><br>
